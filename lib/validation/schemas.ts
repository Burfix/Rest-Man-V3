...
export const createMaintenanceIssueSchema = z.object({
  ...
  impact_level: z.enum(["none", "low", "medium", "high", "service_blocking", "minor", "service_disruption", "revenue_loss", "compliance_risk", "food_safety_risk"]).optional().nullable(),
  service_blocking: z.boolean().optional(),
